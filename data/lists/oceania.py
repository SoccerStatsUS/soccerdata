...
oceania = [
    ...
    (1989, 'New Zealand', 'Wynton Rufer', 'Switzerland', 'Grasshopper-Club Zürich'),
    ...
    (2005, 'French Polynesia', 'Marama Vahirua', 'France', 'Lorient'),
    (2006, 'New Zealand', 'Ryan Nelsen', 'England', 'Blackburn Rovers'),
    (2007, 'New Zealand', 'Shane Smeltz', 'Australia', 'Wellington Phoenix'),
    (2008, 'New Zealand', 'Shane Smeltz', 'Australia', 'Wellington Phoenix'),
    (2009, 'New Zealand', 'Ivan Vicelich', 'New Zealand', 'Auckland City FC'),
