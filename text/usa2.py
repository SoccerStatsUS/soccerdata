...
'G.Thompson': 'Gregg Thompson',
    ...
    'T.Steel': 'Tommy Steel',
    'B. Wilson': 'Bob Wilson',
    'W.Carniham': 'Bill Carnihan',
    'B.Millar': 'Bob Millar',
    'R.Hornberger': 'Ray Hornberger',
    'F.Kerr': 'Findlay Kerr',
    'J.Marshall': 'Jack Marshall',
    'B.Wilson': 'Billy Wilson',
    'B.Morris': 'Bill Morris',
    'G.Burness': 'Gordon Burness',
    'B.Battles': 'Barney Battles',
    'G.Tintle': 'George Tintle',
    'C.Spalding': 'Dick Spalding',
    'M.Diedrichsen': 'Matt Diedrichsen',
    'J.Hemingsley': 'John Hemingsley',
    'C.Ellis': 'Charles Ellis',
    'J.Ford': 'James Ford',
    'J.Duffy': 'John Duffy',
    'J.Lyons': 'Jim Lyons',
    'R.Aitken': 'Robert Aitken',
    'R.Kuntner': 'Rudolf Kuntner',
    'P.Slone': 'Philip Slone',
    'M.Bookie': 'Mike Bookie',
    'J.Hjulian': 'Julius Hjulian',
    'A.Czerchiewicz': 'Ed Czerkiewicz',
    'P.Pietras': 'Peter Pietras',
    'W.Nilsen': 'Werner Nilsen',
    'W.Dick': 'Walter Dick',
    ...
    'S.McAlees': 'Sam McAlees',
    'J.Michaels': 'Joseph Michaels',
    'J.Machado': 'Joe Machado',
    'J.Ferreira': 'Joe Ferreira',
    'J.Braga': 'Jesse Braga',
    'R.Beckman': 'Raymond Beckman',
    'A.Strimel': 'Archie Strimel',
    'R.Annis': 'Robert Annis',
    'S.Grivnow': 'Stee Grivnow',
    'G.Olaff': 'Gene Olaff',
    'P.Matevich': 'Pete Matevich',
    'H.Graesser': 'Herman Graesser',
    'A.Muniz': 'Amiel Muniz',
    'B.Wattman': 'Ben Wattman',
    'J.Hynes': 'Jack Hynes',
    'T.Springthorpe': 'Terry Springthorpe',
    'T.Schultz': 'Tom Schultz',
    'O.Decker': 'Otto Decker',
    'W.Connelly': 'Bill Connelly',
    'Y.Chacurian': 'Efrain Chacurian',
    'E.Embarger': 'Edward Embarger',
    'Corn.Casey': 'Cornelius Casey',
    'D.Malinowski': 'Donald Malinowski',
    'H.Wecke': 'Herman Wecke',
    'R.Craddock': 'Robert Craddock',
    'D.Nash': 'Derek Nash',
    'S.Engedal': 'Svend Engedal',
    'G.Brown': 'George Brown',
    'Z.Snylyk': 'Zenon Snylyk',
    'L.Franks': 'Leroy Franks',
    'V.Pellizaro': 'Val Pelizzaro',
    'R.Rooney': 'Bob Rooney',
    'R.Burkard': 'Bob Burkard',
    'R.Whitehead': 'Bob Whitehead',
    'V.Ottobini': 'Victor Ottoboni',
    'B.Cinowitz': 'Ben Cinowitz',
    'B.Evans': 'Bert Evans',
    'W.Carson': 'Willie Carson',
    'J.Speca': 'Joe Speca',
    'W.Freitag': 'Willie Freitag',
    'E.Herz': 'Eberhard Herz',
    'H.Bicek': 'Helmut Bicek',
    'K.Fister': 'Carl Fister',
    'W.Ronge': 'Walter Ronge',
    'A.Bonezzi': 'Tony Bonezzi',
    'FB.Jones': 'F. Burke Jones',
    'A.Brix': 'Aage Brix',
    'S.Dalrymple': 'Sam Dalrymple',
    'F.O\'Connor': 'Fred O\'Conner',
    'J.Mulholland': 'Jakes Mulholland',
    'W.Demko': 'William Demko',
    'C.Johnson': 'Carl Johnson',
    'H.Wells': 'Herbert Wells',
    'J.Rhody': 'James Rhody',
    'H.O\'Carroll': 'Razzo Carroll',
...
class TextProcessor(object):
    ...
    def process_single_player(self, item, on, off):
        ...
        for goal in range(goals):
            self.goals.append({
                    'goal': get_name(name_map.get(name, name)),
                    'minute': None,
                    'date': self.date,
                    'team': 'United States',
                    'season': self.date.year,
        ...
        self.lineups.append({
                'name': get_name(name_map.get(name, name)),
                'on': on,
                'off': off,
                'team': 'United States',
                'date': self.date,
