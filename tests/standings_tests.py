...
from soccerdata.text.standings import process_string

BASIC = """
Competition: Major League Soccer
Season: 2010
Group: Eastern Conference
Key: team; games_played; wins; ties; losses; points; goals_for; goals_against
...
def test_basic_standings():
    ...
    assert_equal(s['games_played'], 34)
    ...
    assert_equal(s2['games_played'], 34)
